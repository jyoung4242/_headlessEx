...
export abstract class Clock {
  ...
  public toIntervalClock() {
    const intervalClock = new IntervalClock({
      ...this._options,
    });
...
export class IntervalClock extends Clock {
  private _running = false;
