...
export class Actor extends Entity implements Eventable, PointerEvents, CanInitialize, CanUpdate, CanBeKilled {
  ...
  public clone(): Actor {
    ...
    const builtInComponents: Component[] = [this.transform, this.pointer, this.motion, this.actions, this.body, this.collider];
  ...
  public once<TEventName extends EventKey<ActorEvents>>(
